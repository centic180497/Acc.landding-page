/* =========================================================
   ...
   Reveal · Accordion · Testimonial slider · Smooth scroll
   ========================================================= */
(function () {
  "use strict";
  ...
  // WordPress can enqueue this file in the <head> or defer/async it.
  // Wait for the DOM so `.reveal` elements are found before `js-enabled` hides them.
